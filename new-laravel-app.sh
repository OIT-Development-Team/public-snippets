...
EOL
    ...
    curl https://raw.githubusercontent.com/OIT-Development-Team/public-deploy-scripts/refs/tags/stable/vite.config.js -o vite.config.js
    ...
    if $tailwind; then
        ...
        curl https://raw.githubusercontent.com/OIT-Development-Team/public-deploy-scripts/refs/tags/stable/tailwind.config.js -o tailwind.config.js
        curl https://raw.githubusercontent.com/OIT-Development-Team/public-deploy-scripts/refs/tags/stable/app.css -o resources/css/app.css
